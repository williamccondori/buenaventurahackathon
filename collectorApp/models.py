...
class detalle_actividad(models.Model):
    ...
    labor_destino=models.CharField(max_length=20, null=False)
    observaciones=models.CharField(max_length=20, null=False)
    tipo_material= models.CharField(max_length=20, null=False)
    labor_s=models.CharField(max_length=20, null=False)
    proyecto_s=models.CharField(max_length=20, null=False)
    fila_s=models.CharField(max_length=20, null=False)
    num_taladro_s=models.CharField(max_length=20, null=False)
    num_barras_s=models.CharField(max_length=20, null=False)
    longitud_s=models.CharField(max_length=20, null=False)
    inclinacion_s=models.CharField(max_length=20, null=False)
    num_broca_s=models.CharField(max_length=20, null=False)
    hr_diesel_inicial=models.CharField(max_length=20, null=False)
